...
public class WorldTest {
    ...
    public void testGet() {
        ...
        World world = new World(null, "My World");
    ...
    public void testPut_Place() {
        ...
        int x = 4, y = 6;
        World instance = new World(null, "MyWorld");
    ...
    public void testGetPlaceNameCount() {
        ...
        String name = "MyPlace";
        World instance = new World(null, "My World");
        int expResult = 0;
    ...
    public void testGetName() {
        ...
        String name = "MyWorld";
        World instance = new World(null, name);
    ...
    /**
     * Test of getFile method, of class World.
     */
    @Test
    public void testGetFile() {
        System.out.println("getFile");

        String file = "/tmp/worldfile";
        World instance = new World(file, "MyWorld");
