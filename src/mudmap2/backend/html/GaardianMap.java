...
public class GaardianMap {
    ...
    public static void writeFile(String filestr, Layer layer){
        ...
        try {
            ...
            List<String> linesTop = readRessource("mudmap2/resources/gaardian/map_top.html");
            List<String> linesBody = readRessource("mudmap2/resources/gaardian/map_body.html");
            List<String> linesBottom = readRessource("mudmap2/resources/gaardian/map_bottom.html");
            List<String> linescss = readRessource("mudmap2/resources/gaardian/maps.css");
