 ...
 * @author neop
 */
public class LegendEntryTitleTest {
    ...
    /**
     * Test of getHeight method, of class LegendEntryTitle.
     */
    @Test
    public void testGetHeight() {
        ...
        LegendEntryTitle instance = new LegendEntryTitle(title);
    ...
    /**
     * Test of getWidth method, of class LegendEntryTitle.
     */
    @Test
    public void testGetWidth() {
        ...
        int expResult = fm.stringWidth(title);
        int result = instance.getWidth(g);
        assertEquals(expResult, result);
    }

    /**
     * Test of renderGraphic method, of class LegendEntryTitle.
     */
    @Test
